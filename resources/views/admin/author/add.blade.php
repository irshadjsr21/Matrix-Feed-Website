              ...
              <div class="card-body">
                  <form method="POST" action="/admin/author" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-12 col-md-10">
                                <textarea type="text" class="form-control @error('about') is-invalid @enderror" name="about" autocomplete="current-about">{{ old('about') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-10">
                                  ...
                                  <small>
                                      <strong>Password will be automatically generated if not provided.</strong>
                                  </small>
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
